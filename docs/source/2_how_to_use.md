...
2.如果首次启动，扬声器播放“已打开热点”；如果之前连接过WIFI，大概多等待10秒，扬声器播放“已连接WIFI”；

3.扬声器播放“小白正在启动，请稍等”，继续等待大约20秒，会在屏幕显示出表情或提示语；

4.扬声器播放并且屏幕显示“正在加载离线语音识别模型，请稍等……”，等待kaldi语音识别模型加载完毕；
...
**如果您的手机没有用二维码分享WIFI密码的功能，请看如下步骤：**
...
4.将小白机器人的摄像头对准显示了WIFI二维码的屏幕界面，听到“叮”的一声之后表示扫码成功，然后扬声器播放“开始连接网络，请稍等……”，等待几秒种后扬声器播放“已连接到网络：xxxx，开始重启”；

5.等待小白机器人重启完成。

## 3.如何判断配网成功（向小白说读取IP地址）
...
2.打开App界面如下图的截图1，在MASTER界面中填写小白机器人的IP地址（向小白说读取IP地址获取），确保手机和小白机器人连接了同一个WIFI，然后点击CONNECT按钮，如下图的截图1显示绿色标志Connected表示成功连接机器人；
